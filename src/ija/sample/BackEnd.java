...
//        s1.addStop(stop3);
        ...
        Street s1 = Street.defaultStreet("first", Arrays.asList(c1, c2, c3), Arrays.asList(stop1, stop2, stop3));
//        s2.addStop(stop4);
//        s2.addStop(stop5);
        Street s2 = Street.defaultStreet("second",Arrays.asList(c3, c4, c5), Arrays.asList(stop4, stop5));
